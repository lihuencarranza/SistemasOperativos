 ...
 *  IMPORTANT
 *  ---------
 *      An execcmd struct can have EXEC or REDIR type depending on if the
 ...
 * --------
 *
 * It contains the same information as 'cmd' plus two fields representing the
 * left and right part of a command of the form: "command1 arg1 arg2 | command2
 * arg3"
 */
struct pipecmd {
  int type;
 ...
 * command to be executed. Take a look to the parsing.c file for better
 * understandig.
 *
